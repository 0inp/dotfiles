...
vim.keymap.set("v", "mn", ":<C-u>ToggleNumberVisual<CR>", {
	desc = "Toggle numbers on selected lines",
	buffer = true,
})

vim.keymap.set("v", "mb", ":<C-u>ToggleBulletVisual<CR>", {
	desc = "Toggle bullets on selected lines",
	buffer = true,
})

vim.keymap.set("v", "mc", ":<C-u>ToggleCheckboxVisual<CR>", {
	desc = "Toggle checkboxes on selected lines",
	buffer = true,
})

vim.keymap.set("v", "mt", ":<C-u>ToggleTaskStateVisual<CR>", {
	desc = "Toggle task state on selected lines",
	buffer = true,
})

vim.keymap.set("v", "ml", ":<C-u>SmartListToggleVisual<CR>", {
	desc = "Smart list toggle on selected lines",
	buffer = true,
})

-- normal mode keymaps (call functions directly)
vim.keymap.set("n", "mn", ToggleNumberCurrentLine, {
	desc = "Toggle numbers on current line",
	buffer = true,
})

vim.keymap.set("n", "mb", ToggleBulletCurrentLine, {
	desc = "Toggle bullets on current line",
	buffer = true,
})

vim.keymap.set("n", "mc", ToggleCheckboxCurrentLine, {
	desc = "Toggle checkboxes on current line",
	buffer = true,
})

vim.keymap.set("n", "mt", ToggleTaskStateCurrentLine, {
	desc = "Toggle task state on current line",
	buffer = true,
})

vim.keymap.set("n", "ml", SmartListToggleCurrentLine, {
